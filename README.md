...
These scripts are works-in-progress that I use for my own characters in-game (Ziphion/Ziphemet). I'm posting these publicly as a way to offer more examples for people to reference as they craft their own lua scripts. Only a few jobs are represented here (SAM, THF, WHM, BLU, BRD, BLM, SMN, RNG, and GEO); as I start using other jobs more, I will add luas for them here.
